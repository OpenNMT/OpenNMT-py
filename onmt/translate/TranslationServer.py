...
class ServerModel:
    ...
    def run(self, inputs):
        ...
        results = [self.maybe_detokenize(_)
                   for _ in self.out_file.getvalue().split("\n")]
