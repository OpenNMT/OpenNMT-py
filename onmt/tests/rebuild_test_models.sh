...
$my_python train.py -data data/data -save_model tmp -gpuid 0 -rnn_size 256 -word_vec_size 256 -layers 1 -epochs 10 -optim adam  -learning_rate 0.001 -rnn_type LSTM -input_feed 0
#-truncated_decoder 5 
#-label_smoothing 0.1
...
$my_python train.py -data data/morph/data -save_model tmp -gpuid 0 -rnn_size 400 -word_vec_size 100 -layers 1 -epochs 8 -optim adam  -learning_rate 0.001
