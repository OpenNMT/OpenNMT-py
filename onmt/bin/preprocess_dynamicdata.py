...
from onmt.dynamicdata.vocab import prepare_vocabulary, save_fields, load_fields, save_transforms, load_transforms
...
def vocab_main(config_file):
    ...
    transform_models = make_transform_models(data_config)
    transforms = make_transforms(transform_models, data_config)
    fields = prepare_vocabulary(data_config, get_specials(transforms))
