...
from onmt.generate.decode_strategy import DecodeStrategyGenerate
from onmt.utils.misc import tile

import warnings


class BeamSearchGenerate(DecodeStrategyGenerate):
    ...
    def __init__(self, beam_size, batch_size, pad, bos, eos, n_best,
        ...
        super(BeamSearchGenerate, self).__init__(
    ...
    def initialize(self, src, src_lengths, src_map=None, device=None,
        ...
        super(BeamSearchGenerate, self).initialize(src, 
            src_map, self.memory_lengths, device, target_prefix)
    ...
    def update_finished(self):
        ...
        self.memory_lengths = self.memory_lengths.view(_B_old, self.beam_size) \
